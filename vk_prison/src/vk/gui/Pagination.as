...
public class Pagination extends Sprite {
    ...
    private var elemsOnPage:uint = 0; // current page
    private var p_cnt:uint = 0; // pagination type
    private var cur_p:uint = 0; // visible pages count = 2 * p_vis + 1
    private var tp:uint = 0;
    private var p_vis:uint = 0;
    private var y2:uint = 0; // up buttons container
    private var cur_x:uint = 0; // down buttons container
    private var cont1:Sprite = null; // "current page" up sprite
    private var cont2:Sprite = null; // "current page" down sprite
    private var cp1:Sprite = null;
    private var cp2:Sprite = null;
