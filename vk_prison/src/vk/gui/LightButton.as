...
public class LightButton extends LinkButton {
    public static const CENTER:uint = 0; // color
    public static const LEFT:uint = 1; // active color
    public static const RIGHT:uint = 2; // text color

    public function LightButton(label:String, x:int, y:int, width:uint, color:int, active_color:int, text_color:uint, active_text_color:uint, align:uint = CENTER, font_size:uint = 11, margins:uint = 4):void {
    ...
    private var tc:uint = 0;
    private var atc:uint = 0;
