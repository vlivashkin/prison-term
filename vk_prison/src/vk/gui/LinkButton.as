...
public class LinkButton extends Button {
    ...
    internal var fs:uint = 11; // Text Format
    internal var tf:uint = 0; // Width  (used for multiline LinkButton, in other case should be equal to zero)
    internal var w:uint = 0; // Height (used for multiline LinkButton, in other case should be equal to zero)
    internal var h:uint = 0;
